# Trail Computer — the hardware version

← Back to the [phone app README](../README.md).

This is the original project: a small, battery-powered device that helps you
navigate on long hikes with no phone signal. It is built for the Kungsleden in
Swedish Lapland. The phone app later replaced it to save weight, but the device
and its code are kept here.
